            ...
            child: Row(
              children: [
                ElevatedButton(
                  ...
                  child: Text(
                    "Kelas",
                    style: TextStyle(color: isKelasActive ? Colors.white: Colors.black),
                  ),
                ),
                const Gap(12),
                ElevatedButton(
                  ...
                  child: Text(
                    "Lab",
                    style: TextStyle(color: isLabActive? Colors.white: Colors.black),
                  ),
                ),
                const Gap(12),
                ElevatedButton(
                  ...
                  child: Text(
                    "Gudang",
                    style: TextStyle(color: isGudangActive? Colors.white: Colors.black ),
                  ),
                ),
              ],
            ),
