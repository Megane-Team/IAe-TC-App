                        ...
                        onPressed: () async {
                          if (_peminjamanController.text.isEmpty ||
                            ...
                            if (widget.category == 'ruangan') {
                              ...
                              var res = await createPeminjaman(detailPeminjaman.id, null, ruangans.id, null, 'ruangan');
                              ...
                              var res = await createPeminjaman(detailPeminjaman.id, barangs.id, null, null, 'barang');
