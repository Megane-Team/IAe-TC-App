                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: Kelas_1.where((item) =>
                                  item['name'] == uniqueNames[index]).length,
                              itemBuilder: (context, index2) {
                                final items = Kelas_1.where((item) =>
                                    item['name'] == uniqueNames[index]).toList()
                                  ..sort((a, b) {
                                    if (a['status'] == 'Digunakan' &&
                                        b['status'] != 'Digunakan') return 1;
                                    if (a['status'] != 'Digunakan' &&
                                        b['status'] == 'Digunakan') return -1;
                                    return int.parse(a['kode_barang']!)
                                        .compareTo(
                                            int.parse(b['kode_barang']!));
                                  });
                                return Container(
